<div>
<div class="flex justify-center items-center h-screen herobg">
      ...
      <?php include 'components/header.php';?>
        <div class="flex justify-around">
            ...
            <div class="text text-white ml-16 flex-1 flex-col justify-center items-center">
                <h1 class="flex-col text-5xl font-bold flex-1 mt-20">Making Christlike Disciples</h1>
                ...
                <button class="mt-5 bg-pink-600 py-2 px-4 rounded-md">Contact Us</button>
            </div>
            <div class="image flex-1"></div>

         
        </div>
        <div class="flex justify-center text-3xl text-red-600 mt-10 italic"><p>"This site is underconstruction"</p></div>
      </div>
  </div>
